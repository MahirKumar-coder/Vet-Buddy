...
export function SectionCTA({ variant = "default" }: SectionCTAProps) {
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-navy-900 via-slate-800 to-navy-900 p-6 shadow-glass-lg md:p-10">
        ...
        <div className="relative flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-5 py-3 text-sm font-semibold text-navy-900 shadow-float transition hover:scale-[1.02] active:scale-[0.98]"
            >
            ...
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 rounded-full border border-white/30 bg-white/10 px-5 py-3 text-sm font-semibold text-white backdrop-blur-md transition hover:bg-white/20"
            >
